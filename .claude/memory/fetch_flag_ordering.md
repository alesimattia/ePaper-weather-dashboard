...
description: Perchè g_cinema_attempted e g_cinema_last_fetch_day vengono settati PRIMA delle alloc/HTTP
type: feedback
---
...
- Accettato perchè la locandina cambia raramente e l'utente non se ne accorge se il fallback è fresco di ieri.
